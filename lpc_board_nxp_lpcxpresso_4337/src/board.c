...
static const io_port_t gpioLEDBits[] = {{0, 14}, {1, 11}, {1, 12}};
...
void Board_UART_Init(LPC_USART_T *pUART)
{
	...
	Chip_SCU_PinMuxSet(0x7, 1, (SCU_MODE_INACT | SCU_MODE_FUNC2));					/* P6,4 : UART0_TXD */
	Chip_SCU_PinMuxSet(0x7, 2, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC1));/* P2.1 : UART0_RXD */
}
